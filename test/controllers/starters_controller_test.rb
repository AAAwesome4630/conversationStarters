...
class StartersControllerTest < ActionController::TestCase
  ...
  test "should create starter" do
    assert_difference('Starter.count') do
      post :create, starter: { category: @starter.category, content: @starter.content, downvotes: @starter.downvotes, upvotes: @starter.upvotes }
    end
  ...
  test "should update starter" do
    patch :update, id: @starter, starter: { category: @starter.category, content: @starter.content, downvotes: @starter.downvotes, upvotes: @starter.upvotes }
    assert_redirected_to starter_path(assigns(:starter))
  end
